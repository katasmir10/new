<?php
session_start();
$pass='3101'; // Пароль для входа в Админку
...
<br><br><br><p><a href="https://katasmir10.github.io/new/" target="_blank">Видео инструкция по админке тут —  просто нажмите по этому тексту.</a><br><br>
